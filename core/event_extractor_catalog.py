...
class EventExtractorEntry:
    ...
    factory_callable: Optional[str] = None  # Fully-qualified import path (e.g., "core.extractor_factory._create_openrouter_event_extractor")
...
_EVENT_EXTRACTOR_REGISTRY: List[EventExtractorEntry] = [
    ...
    EventExtractorEntry(
        ...
        enabled=True,
        factory_callable="core.extractor_factory._create_openrouter_event_extractor",
    ...
    EventExtractorEntry(
        ...
        display_name="OpenAI",
        enabled=True,
        factory_callable="core.extractor_factory._create_openai_event_extractor",
    ...
    EventExtractorEntry(
        ...
        enabled=True,
        factory_callable="core.extractor_factory._create_anthropic_event_extractor",
    ...
    EventExtractorEntry(
        ...
        enabled=True,
        factory_callable="core.extractor_factory._create_deepseek_event_extractor",
    ...
    EventExtractorEntry(
        ...
        enabled=True,
        factory_callable="core.extractor_factory._create_opencode_zen_event_extractor",
